...
from training.constants import EXPANDING_WINDOW_DIR, ROUNDING, SET_COMPARISON_MODELS
...
if __name__ == "__main__":
    results_paths = {
        "Chronological": os.path.join(
            "training", "results", "expanded_results_test.csv"
        ),
        "Random": os.path.join(
            "training", "results", "random_expanded_results_test.csv"
        ),
    }
